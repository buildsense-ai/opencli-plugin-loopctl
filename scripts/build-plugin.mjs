...
const entries = ['loop-status','loop-pending','loop-packet','loop-start','loop-fanout','loop-agent-task-fanout','loop-integrate','loop-bundle','loop-runtime-started','loop-candidate','loop-review','loop-next']
