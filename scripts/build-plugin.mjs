...
const entries = ['loop-status','loop-pending','loop-packet','loop-start','loop-fanout','loop-agent-task-fanout','loop-agent-task-start','loop-agent-task-retry','loop-integrate','loop-bundle','loop-workspace-prepare','loop-preflight-ready','loop-readiness-submit','loop-runtime-started','loop-runtime-start-submit','loop-candidate','loop-candidate-submit','loop-review','loop-review-submit','loop-next']
