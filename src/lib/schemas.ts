...
const packetBase = {
  kind: z.enum(['execute_attempt', 'review_candidate', 'plan_next']), schema: z.literal('loopctl-action-packet-v1'),
...
export const actionPacketSchema = z.discriminatedUnion('kind', [executePacket, reviewPacket, nextPacket])
