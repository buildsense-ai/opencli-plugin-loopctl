...
`validate:host` creates an isolated temporary HOME, links this plugin without touching the user's installed plugins, and verifies all nine commands. To use the controller from a development checkout:
